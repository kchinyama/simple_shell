The simple_shell is an ALx Software Engineering project that helps students to 
understand the advanced concepts behind the shell program include process, 
system calls(like execve, fork and wait), bit manipulation, file managment, error handling ...
...
* Handle the Ctrl-C to null terminate the shell
